...
import com.binance.client.model.trade.AssetExchangeInformation;
...
public class ExchangeInformation {
    ...
    private List<AssetExchangeInformation> assets;
    ...
    public List<AssetExchangeInformation> getAssets() {
        return assets;
    }

    public void setAssets(List<AssetExchangeInformation> assets) {
        this.assets = assets;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, BinanceApiConstants.TO_STRING_BUILDER_STYLE).append("timezone", timezone)
                .append("serverTime", serverTime).append("rateLimits", rateLimits).append("futuresType", futuresType)
