...
public interface SyncRequestClient {
     ...
     * @return
     */
    List<Order> postBatchOrders(String batchOrders);
    ...
    /**
     * modify in a new order.
     *
     * @return Order.
     */
    Order modifyOrder(Long orderId, String origClientOrderId, String symbol, OrderSide side, BigDecimal quantity, BigDecimal price);
     ...
     * @return ResponseResult.
     */
    DualSidePosition getPositionSide();
     ...
     * 获取所有杠杆分层标准
     *
     * @return List<leverageBracket>
     */
    List<LeverageBracket> getAllLeverageBracket();
