...
public class SyncRequestImpl implements SyncRequestClient {
    ...
    @Override
    public List<Order> postBatchOrders(String batchOrders) {
    ...
    @Override
    public Order modifyOrder(Long orderId, String origClientOrderId, String symbol, OrderSide side, BigDecimal quantity, BigDecimal price) {
        return RestApiInvoker.callSync(requestImpl.modifyOrder(orderId, origClientOrderId, symbol, side, quantity, price));
    }
    ...
    @Override
    public DualSidePosition getPositionSide() {
    ...
    public LeverageBracket getLeverageBracket(String symbol) {
        return RestApiInvoker.callSync(requestImpl.getLeverageBracket(symbol));
    }

    @Override
    public List<LeverageBracket> getAllLeverageBracket() {
        return RestApiInvoker.callSync(requestImpl.getAllLeverageBracket());
    }
