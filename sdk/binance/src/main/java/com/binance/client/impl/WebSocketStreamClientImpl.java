...
public class WebSocketStreamClientImpl implements SubscriptionClient {
    ...
    private <T> void createConnection(WebsocketRequest<T> request, boolean autoClose) {
        ...
        WebSocketConnection connection = new WebSocketConnection(request, watchDog, autoClose, request.requestKey);
        connection.setRequestKey(request.requestKey);
        if (autoClose == false) {
    ...
    public void unsubscribeByKey(String key) {
        for (WebSocketConnection connection : connections) {
            if (Objects.equals(connection.getRequestKey(),key)) {
